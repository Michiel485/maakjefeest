...
- [ ] **`migration_gekregen.sql` draaien** (twee kolommen op rsvp: `std_kaart_id`, `inv_kaart_id`). Zonder werkt alles, maar onthoudt de gastenlijst niet welke kaart je bij "verstuurd zetten" koos. De SQL staat in het gesprek van 21 sep 2026 en in `supabase/migration_gekregen.sql`.
