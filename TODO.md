...
- [x] 24 sep 2026: **Dubbele gasten voorkomen en opruimen, en per gast via WhatsApp.** Een telefoon die al eens antwoordde krijgt de keuze "dat aanpassen" (namen staan er al) of "iemand anders aanmelden" (eerdere antwoorden blijven staan); dat loste ook op dat een tweede aanmelding op hetzelfde toestel de eerste terugzette. De gastenlijst wijst vermoedelijke dubbelen aan (bijna dezelfde naam, of dezelfde mail of telefoon over huishoudens heen) met Samenvoegen / Nee, twee mensen, en twee aangevinkte regels kun je samenvoegen. Per gast een WhatsApp-knop: opent je eigen WhatsApp met zijn persoonlijke link (`?gast=`) en het bericht klaar, en zet hem op verstuurd. In de kaarttegels "Bekijk reacties" met namen en komt/komt niet. Ook gevonden en gerepareerd: na een betaalde Save the Date rekende de kassa via het dashboard het volle bedrag voor de trouwkaart en de website in plaats van het verschil.
