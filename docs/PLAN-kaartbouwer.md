...
- **Nog vier details uit de testronde van 11 september:**
  1. De dichte envelop zweeft op en neer, en op het hoogste punt kwam er een randje kaart onder de envelop uit. De klip trekt nu `ENVELOP_ZWEEF` van de onderrand af, dus op het hoogste punt sluit het precies aan (gemeten: envelop en kaart eindigen beide op 539).
  2. De afronding van de kaart leek vierkant omdat de achtergrond in het emerald-thema bijna dezelfde kleur heeft als de kaart. De afronding zelf klopt, op vijf keer uitvergroot volgt de achtergrond hem exact; wat ontbrak was contrast. De kaart heeft nu twee schaduwen: een korte tegen de rand die de afronding laat lezen, en de wijde eronder voor de diepte.
