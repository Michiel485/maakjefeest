...
- **Waarom dit niet met CSS-keyframes kan.** De eerste poging (11 sep 2026) ging te snel en het leek niet alsof de kaart uit de envelop kwam. Drie redenen, alle drie fout in de opzet en niet in de tijdsduur:
  ...
  3. De envelop was één laag, dus de kaart lag erachter in plaats van erin. Nu bestaat de envelop uit twee lagen met de kaart ertussen: achterkant en klep onder de kaart, voorkant en zegel erboven. Een kaart zit ín een envelop, dus vóór de achterkant en achter de voorkant, en als hij omhoog komt gaat hij vóór de opengeklapte klep langs. De laag om die twee heen mag geen `transform` en geen `z-index` hebben, want dat maakt een eigen stapelcontext en dan kan de kaart er niet meer tussen; het zweven gaat daarom via `top` en de twee lagen krijgen elk apart hun transform per frame. De klep wordt donkerder als hij opent: je ziet dan de binnenkant, en dat maakt hem ook zichtbaar tegen een achtergrond met bijna dezelfde kleur.
- **Hoe het nu werkt.** De kaart is veel hoger dan de envelop en past er dus nooit echt in. Het oog kijkt naar de afstand tussen de twee: die moet over de animatie precies de kaarthoogte worden. Daarom komt de kaart omhoog (mond plus 60 pixels) en zakt de envelop weg (kaarthoogte min de mond). De mond is de bovenrand van de voorkant, op 58 procent van de envelophoogte. De klip op de kaart volgt per frame die mond, dus er is nooit iets zichtbaar dat in de envelop hoort te zitten. Dat rekenen gebeurt in een `requestAnimationFrame`-lus in `card-reveal.tsx`, niet in keyframes: de hoogtes zijn pas bij het openen bekend en moeten worden opgemeten. Op het laatste stukje (vanaf 82 procent) laten de klip en de envelop samen los, zodat het een overvloeiing is.
